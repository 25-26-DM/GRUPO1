...
fun AppNavigation() {
    ...
    // Lógica para persistencia de sesión: verificamos si hay un usuario guardado
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        ...
                        // Al cerrar sesión, limpiamos SharedPreferences
        ...
        composable(
            ...
            LoginScreen(
                ...
                onLoginSuccess = { userName -> 
                    // Al loguearse con éxito, guardamos la sesión
