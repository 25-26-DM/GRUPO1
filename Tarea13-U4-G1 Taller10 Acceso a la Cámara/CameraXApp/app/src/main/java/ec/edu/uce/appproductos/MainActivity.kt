...
import ec.edu.uce.appproductos.ui.home.DashboardScreen
...
import ec.edu.uce.appproductos.ui.camera.CameraScreen
...
fun AppNavigation() {
    ...
    val startRoute = if (savedUser != null) "dashboard/$savedUser" else "login"
    ...
    NavHost(navController = navController, startDestination = startRoute) {
        ...
        composable(
            ...
            DashboardScreen(
                ...
                onNavigateToProducts = { navController.navigate("home/$userName") },
